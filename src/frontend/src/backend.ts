...
import type { UserRole as _UserRole, Validated as _Validated, ValidatedInput as _ValidatedInput, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTodo(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async editTodo(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editTodo(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodo(arg0: bigint): Promise<Validated | null> {
        if (this.processError) {
            try {
    ...
    async getTodos(): Promise<Array<ValidatedInput> | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Validated]): Validated | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_ValidatedInput>]): Array<ValidatedInput> | null {
    return value.length === 0 ? null : value[0];
}
